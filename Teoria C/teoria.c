/*
    ...
    Server :
    - socket()
    - bind() --->Elaboriamno tutti i dati che sono stati inviati nella porta specificata
    - recvfrom()    <--
    - sendto()      -->* // prendera come parametro il descrittore di socket dell'host di destinazione  
    - close()
